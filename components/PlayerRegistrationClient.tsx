        ...
        async function onSubmit(values: PlayerRegistrationForm) {
            ...
            try {
                const payload = {
                    ...
                    available_days: values.days.map(day => parseInt(day, 10)),
                };
                            ...
                            <CardContent className="p-6 pt-0">
                                <Form {...form}>
                                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                        ...
                                        <div className="space-y-4 border-b border-slate-700/50 pb-6">
                                            <h2 className="text-purple-500 text-xl font-semibold">Disponibilidad</h2>
                                            <div className="text-slate-200 gap-4">
                                                <FormField
                                                    control={form.control}
                                                    name="days"
                                                    render={() => (
