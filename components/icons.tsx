...
export const GameIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    viewBox="0 0 24 24"
    ...
    strokeLinejoin="round"
  >
    <path d="m15.132 18.3-5.264-5.264a2 2 0 0 1 0-2.828L15.132 5.7" />
    <path d="M19.899 22.066a2 2 0 0 1-2.828 0l-1.414-1.414a2 2 0 0 1 0-2.828l3.535-3.536a2 2 0 0 1 2.828 0l1.414 1.414a2 2 0 0 1 0 2.828z" />
    <path d="m3.543 2.122 8.485 8.485" />
    <path d="M11.96 12.039 3.475 3.554" />
    <path d="M3.475 20.55 12 12" />
  </svg>
)
...
export const PodiumIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M5.5 12a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
    <path d="M12 11.5c-2 0-4.27.92-5.5 2.5" />
    <path d="M12 11.5c2 0 4.27.92 5.5 2.5" />
    <path d="M12 4c-2 0-4.27-.92-5.5-2.5" />
    <path d="M12 4c2 0 4.27-.92 5.5-2.5" />
    <path d="m18.5 9.5-4-2" />
    <path d="m5.5 9.5 4-2" />
  </svg>
)
...
export const TwitterIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9-6.1-1.4-6.1-6.1-6.1-6.1s-2.1-.7-4.2 2.1c-2.5-2.8-5.6-2.8-5.6-2.8l-2.1 6.1c-1.4 2.1 2.8 5.6 5.6 5.6 2.8 0 5.6-2.8 5.6-5.6l2.1-7.8z" />
  </svg>
)
